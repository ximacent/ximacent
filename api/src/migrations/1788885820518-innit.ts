...
export class Innit1788885820518 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "categories" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isDeleted" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying(255) NOT NULL, "description" text, "display_order" integer NOT NULL DEFAULT '0', "election_id" uuid, CONSTRAINT "UQ_ae1a68c788dcade273b4f6d11e5" UNIQUE ("name", "election_id"), CONSTRAINT "PK_24dbc6126a28ff948da33e97d3b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."elections_status_enum" AS ENUM('draft', 'active', 'closed')`);
        await queryRunner.query(`CREATE TABLE "elections" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "isDeleted" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "title" character varying(255) NOT NULL, "alias" character varying(20), "slug" character varying(255) NOT NULL, "description" text, "start_date" TIMESTAMP WITH TIME ZONE NOT NULL, "end_date" TIMESTAMP WITH TIME ZONE NOT NULL, "price_per_vote" numeric(10,2) NOT NULL, "status" "public"."elections_status_enum" NOT NULL DEFAULT 'draft', "banner_url" character varying, "created_by" uuid NOT NULL, CONSTRAINT "UQ_6f7f24fcfa8f501307cc1d40457" UNIQUE ("title"), CONSTRAINT "UQ_64d001e594dddac45eb2ecc4a80" UNIQUE ("alias"), CONSTRAINT "UQ_43f359038496720f003d917a58d" UNIQUE ("slug"), CONSTRAINT "PK_21abca6e4191b830d1eb8379cf0" PRIMARY KEY ("id"))`);
