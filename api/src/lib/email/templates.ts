...
/**
 * Shared Ximacent email layout.
 *
 * Design:
 * - Dark premium background
 * - Warm champagne/gold Ximacent accent
 * - Cream typography
 * - Responsive, email-client-friendly table layout
 * - Inline styles for Gmail, Outlook, Apple Mail, etc.
 */
function wrap(
  bodyHtml: string,
  options?: {
  ...
  return {
    ...
    html: wrap(
      `
        ...
        ${infoBox("New account role", newRole)}
  ...
  return {
    ...
    html: wrap(
      `
        ...
        ${paragraph(
          strong("If this wasn't you, contact support immediately.")
        )}
      `,
      {
  ...
  return {
    ...
    html: wrap(
      `
        ...
        ${infoBox("New phone number", newPhone)}
    ...
    html: wrap(
      `
        ${heading(
          ...
          `We've received your organizer application for ${APP_NAME}.`
        )}
  ...
  return {
    ...
    html: wrap(
      `
        ${heading(
          "You're approved",
          `Congratulations! Your ${APP_NAME} organizer application has been approved.`
        )}
      ...
      `,
      {
        preheader: `Your ${APP_NAME} organizer application has been approved.`,
      }
    ),
  };
}
    ...
    html: wrap(
      `
        ${heading(
          ...
          `Your ${APP_NAME} organizer application was not approved at this time.`
        )}
      ...
      `,
      {
        preheader: `Your ${APP_NAME} organizer application needs changes.`,
      }
    ),
  };
}
    ...
    html: wrap(
      `
        ${heading(
          ...
          `There has been a change to your ${APP_NAME} organizer account.`
        )}
      ...
      `,
      {
        preheader: `Your ${APP_NAME} organizer account has been suspended.`,
      }
    ),
  };
}
...
export function lowSmsCreditTemplate(
  ...
  return {
    ...
    html: wrap(
      ...
      `,
      {
        preheader: `The mNotify SMS account has only ${creditLeft} credits remaining.`,
      }
    ),
  };
}
...
export function electionLaunchedTemplate(
  electionTitle: string
): Omit<EmailMessage, "to"> {
  return {
    ...
    html: wrap(
      `
        ${heading(
          ...
          `Your ${APP_NAME} election has reached its start date.`
        )}
        ...
        ${paragraph(
          "Your election is now live and accepting votes."
        )}

        ${paragraph(
          "Voters can now participate in your election."
        )}
      `,
      {
        preheader: `"${electionTitle}" is now live and accepting votes.`,
      }
    ),
  };
}
