...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-soft hover:bg-champagne-soft hover:shadow-glow",
        destructive:
          "bg-destructive text-destructive-foreground shadow-soft hover:bg-rose-soft",
        outline:
          "border border-border bg-transparent text-foreground hover:border-champagne/50 hover:bg-secondary hover:text-champagne",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-surface-elevated",
        ghost: "hover:bg-secondary hover:text-champagne",
        link: "text-champagne underline-offset-4 hover:underline hover:text-champagne-soft",
      },
      size: {
