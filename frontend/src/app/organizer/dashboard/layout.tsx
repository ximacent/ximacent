...
export default function OrganizerDashboardLayout({ children }: { children: React.ReactNode }) {
  return <OrganizerProtectedRoute>
    <div className="flex h-screen overflow-hidden bg-ink">
      ...
      <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden"><OrganizerMobileNav /><main className="min-h-0 flex-1 overflow-y-auto overflow-x-hidden">{children}</main></div>
    </div>
